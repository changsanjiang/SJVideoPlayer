...
FOUNDATION_EXTERN NSNotificationName const MCSAssetManagerDidRemoveAssetNotification;
FOUNDATION_EXPORT NSNotificationName const MCSAssetManagerUserCancelledReadingNotification;
FOUNDATION_EXTERN NSString *MCSAssetManagerUserInfoAssetKey;
...
@property (nonatomic, readonly) NSUInteger cachedSizeForAssets;
