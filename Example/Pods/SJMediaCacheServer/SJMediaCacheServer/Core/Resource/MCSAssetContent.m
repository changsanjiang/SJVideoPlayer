...
- (void)setDelegate:(nullable id<MCSAssetContentDelegate>)delegate {
    dispatch_barrier_sync(_queue, ^{
        self->_delegate = delegate;
    });
}
- (nullable id<MCSAssetContentDelegate>)delegate {
    __block id<MCSAssetContentDelegate> delegate;
