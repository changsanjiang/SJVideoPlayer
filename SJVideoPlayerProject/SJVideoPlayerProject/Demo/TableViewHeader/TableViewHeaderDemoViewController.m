...
- (TableHeaderView *)tableHeaderView {
    ...
    _tableHeaderView.clickedPlayBtn = ^(TableHeaderView * _Nonnull view) {
        ...
        if ( !self ) return;
        SJVideoPlayerURLAsset *asset =
        [[SJVideoPlayerURLAsset alloc] initWithAssetURL:[NSURL URLWithString:@"http://vod.lanwuzhe.com/d57eed43d9a344e486b79ae505fb9044/18b1aeb398e04ffaa9de48f223dcf0ca-5287d2089db37e62345123a1be272f8b.mp4?video="] tableHeaderOfPlayerSuperView:view tableView:self.tableView];
        asset.title = @"DIY心情转盘 #手工##手工制作#";
