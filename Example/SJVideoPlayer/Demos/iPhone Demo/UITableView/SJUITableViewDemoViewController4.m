...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    view.playerSuperviewWasTapped = ^(SJUITableViewSectionHeaderView *headerView) {
        ...
        self.player.URLAsset = [SJVideoPlayerURLAsset.alloc initWithURL:SourceURL0 playModel:[SJPlayModel playModelWithTableView:self.tableView inHeaderForSection:section]];
    };
    return view;
}
@end
