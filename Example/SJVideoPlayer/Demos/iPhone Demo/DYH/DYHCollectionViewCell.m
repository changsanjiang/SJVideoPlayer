...
@interface DYHDemoPlayer : SJBaseVideoPlayer<DYHDemoPlayer>

@end

#pragma mark -

@interface DYHCollectionViewCell () {
    DYHDemoPlayer *_player;
}
@property (nonatomic, strong) UIImageView *playImageView;
@end

@implementation DYHCollectionViewCell
...
- (void)setAllowsPlayback:(BOOL (^_Nullable)(id<DYHDemoPlayer> _Nonnull))allowsPlayback {
    self.canPlayAnAsset = allowsPlayback;
}

- (BOOL (^_Nullable)(id<DYHDemoPlayer> _Nonnull))allowsPlayback {
