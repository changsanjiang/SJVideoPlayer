...
@interface SJUITableViewFooterView : UIView
@property (nonatomic, strong) UIImageView *avatarImageView;
@property (nonatomic, strong) UILabel *usernameLabel;
@property (nonatomic, strong) UIView *playerSuperview;
@property (nonatomic, strong) UIImageView *playImageView;

@property (nonatomic, copy, nullable) void(^playerSuperviewWasTapped)(SJUITableViewFooterView *headerView);
@end

@implementation SJUITableViewFooterView
...
@interface SJUITableViewDemoViewController3 ()

@end

@implementation SJUITableViewDemoViewController3
- (void)viewDidLoad {
    [super viewDidLoad];
    
    SJUITableViewFooterView *headerView = [SJUITableViewFooterView.alloc initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, 300)];
    self.tableView.tableFooterView = headerView;
    
    
    __weak typeof(self) _self = self;
    headerView.playerSuperviewWasTapped = ^(SJUITableViewFooterView *headerView) {
