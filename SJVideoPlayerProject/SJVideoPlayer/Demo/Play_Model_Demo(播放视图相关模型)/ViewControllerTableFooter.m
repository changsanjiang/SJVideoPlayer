//
//  ViewControllerTableFooter.m
//  SJVideoPlayer
//
//  Created by 畅三江 on 2018/10/4.
//  Copyright © 2018 畅三江. All rights reserved.
//

#import "ViewControllerTableFooter.h"
...
@interface ViewControllerTableFooter ()<SJRouteHandler, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) SJVideoPlayer *player;
@end

@implementation ViewControllerTableFooter

+ (NSString *)routePath {
    return @"tableView/tableFooterView/play";
}
...
- (void)viewDidLoad {
    ...
    SJTableHeaderView *tableFooterView = [[SJTableHeaderView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.width)];
    __weak typeof(self) _self = self;
    tableFooterView.view.clickedPlayButtonExeBlock = ^(SJPlayView * _Nonnull view) {
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(SJTableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.view.clickedPlayButtonExeBlock = ^(SJPlayView * _Nonnull view) {
        ...
        self.player.URLAsset = [[SJVideoPlayerURLAsset alloc] initWithURL:[NSBundle.mainBundle URLForResource:@"play" withExtension:@"mp4"] playModel:[SJPlayModel UITableViewCellPlayModelWithPlayerSuperviewTag:view.coverImageView.tag atIndexPath:indexPath tableView:tableView]];
        self.player.URLAsset.title = @"Test Title";
        self.player.URLAsset.alwaysShowTitle = YES;
    };
}
