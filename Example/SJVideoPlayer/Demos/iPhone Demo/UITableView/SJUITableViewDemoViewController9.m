...
@interface SJUITableViewDemoViewController9 ()<SJVideoTableViewCellDelegate>
@property (nonatomic, strong, readonly) NSMutableArray<SJVideoCellViewModel *> *models;
@end

@implementation SJUITableViewDemoViewController9
...
- (void)coverItemWasTapped:(SJVideoTableViewCell *)cell {
    ...
    if ( !_player ) {
        ...
        // 自定义浮窗的初始位置
        _player.floatSmallViewController.floatViewAlignment = SJFloatViewAlignmentBottomRight;
        _player.floatSmallViewController.floatViewInsets = UIEdgeInsetsMake(0, 0, 20, 12);
