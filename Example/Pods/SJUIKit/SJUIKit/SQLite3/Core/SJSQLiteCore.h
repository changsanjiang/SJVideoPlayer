...
sqlite3_obj_exec_each_result_callback(void *para, int ncolumn, char *_Nullable*_Nullable columnvalue, char *_Nullable*_Nullable columnname);

/// 打开数据库链接
///
FOUNDATION_EXPORT BOOL
sqlite3_obj_open_database(NSString *path, sqlite3 *_Nullable*_Nonnull db);
