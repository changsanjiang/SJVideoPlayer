...
- (void)viewDidLoad {
    ...
    tableHeaderView.clickedPlayButtonExeBlock = ^(SJHasCollectionView * _Nonnull tableHeaderView, SJPlayView * _Nonnull view, NSIndexPath * _Nonnull indexPath) {
        ...
        self.player.URLAsset = [[SJVideoPlayerURLAsset alloc] initWithURL:[NSURL URLWithString:@"https://xy2.v.netease.com/2018/0815/d08adab31cc9e6ce36111afc8a92c937qt.mp4"] playModel:[SJPlayModel UICollectionViewNestedInUITableViewHeaderViewPlayModelWithPlayerSuperviewTag:view.coverImageView.tag atIndexPath:indexPath collectionView:tableHeaderView.collectionView tableView:self.tableView]];
